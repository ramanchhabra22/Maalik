...
<module external.linked.project.id=":react-native-youtube" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-youtube" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:/Users/raman.chhabra/repos/Maalik/node_modules/react-native-youtube/android/libs/YouTubeAndroidPlayerApi.jar:unspecified@jar" level="project" />
  </component>
</module>